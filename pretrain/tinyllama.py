...
def setup(
    training_config: str = "experiments/tinyllama_1b.yaml"
) -> None:
...
def handle_training_config(training_config):
    ...
    training_config.final_linear_cool_down_iters = training_config.final_linear_cool_down_steps * training_config.gradient_accumulation_steps
...
def get_lr(it, training_config):
    ...
    if training_config.lr_schedule == "cosine_with_final_linear_cool_down":
        if it <= training_config.lr_decay_iters - training_config.final_linear_cool_down_iters: 
            ...
            # linearly decay to 0
            coeff = (training_config.lr_decay_iters - it) / training_config.final_linear_cool_down_iters
            return training_config.min_lr * coeff
