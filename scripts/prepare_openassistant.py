...
def prepare(
    destination_path: Path = Path("data/openassistant"),
    checkpoint_dir: Path = Path("checkpoints/stabilityai/stablelm-base-alpha-3b"),
    test_split_fraction: float = 0.,
    seed: int = 42,
    mask_inputs: bool = False,
    data_file_name: str = "openassistant_data_cleaned.json",
    data_file_url: str = "https://huggingface.co/datasets/OpenAssistant/oasst_top1_2023-08-25/blob/main/oasst_top1_2023-08-25_train.jsonl",
    ignore_index: int = -1,
...
def prepare_sample(
    ...
    full_prompt_and_response = example["text"]
